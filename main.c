...
// The list of variables in .data section and their locations.
    ...
    struct callinstruction calltable[100];
    int noofcalls=0;
...
//========================================   FIRST PASS  ======================================================
            while (token)
            {
                ...
                else if (strcmp(token,"and")==0) //----------------- AND -------------------------------
                {
                    //to be added
                    op1 = strtok(NULL,"\n\t\r ");
                   op2 = strtok(NULL,"\n\t\r ");
                ...
                else if (strcmp(token,"xor")==0) //----------------- XOR -------------------------------
                {
                    //to be added
                    op1 = strtok(NULL,"\n\t\r ");
                    op2 = strtok(NULL,"\n\t\r ");
                ...
                else if (strcmp(token,"not")==0) //----------------- NOT -------------------------------
                {
                    op1 = strtok(NULL,"\n\t\r ");
                    op2 = strtok(NULL,"\n\t\r ");
                ...
                else if (strcmp(token,"mov")==0) //----------------- MOV -------------------------------
                {
                    //to be added
                    op1 = strtok(NULL,"\n\t\r ");
                    op2 = strtok(NULL,"\n\t\r ");
                ...
                else if (strcmp(token,"inc")==0) //----------------- INC -------------------------------
                {
                    op1 = strtok(NULL,"\n\t\r ");
                ...
                else if (strcmp(token,"dec")==0) //----------------- DEC -------------------------------
                {
                    op1 = strtok(NULL,"\n\t\r ");
                    ch = (op1[0]-48)| ((op1[0]-48)<<3);
                ...
                else if (strcmp(token, "psh")==0) //----------------- PSH -------------------------------
                {
                    op1 = strtok(NULL, "\n\t\r ");
                    chch = ((op1[0]-48)<<6);
                    ...
                    op1 = strtok(NULL, "\n\t\r ");
                    ch = (op1[0]-48);
                    program[counter]=0x9000+((ch)&0x007);
                    counter++;
                }
                else if (strcmp(token, "call")==0) //----------------- CALL -------------------------------
                {
                    op1 = strtok(NULL,"\n\t\r ");
                    calltable[noofcalls].location = counter;
                    op2=(char*)malloc(sizeof(op1));
                    strcpy(op2,op1);
                    calltable[noofcalls].label=op2;
                    noofcalls++;
...
//================================= SECOND PASS ==============================
        ...
        for (i=0; i<noofcalls;i++)                                                                          //for all jump/jz instructions
        {
            j=0;
            while ( strcmp(calltable[i].label , labeltable[j].label) != 0 )                                  //if the label for this call does not match with the 
                j++;                                                                                         // jth label in the labeltable, check the next label..
            program[calltable[i].location] +=(labeltable[j].location-calltable[i].location-1)&0x0fff;        //copy the call address into memory.
        }
